...
trait ActiveUserHelper
{
    ...
    {
    	//尝试从缓存中取出cache_key对应的数据。如果取到，便直接返回数据。
    	//否则运行匿名函数中的代码来取出活跃数据用户，返回的同时做缓存。
    ...
    private function calculateActiveUsers()
    {
    	...
    	//我们需要的是倒序，高分在前，第二个参数为保持数组的KEY不变
    ...
    private function cacheActiveUsers()
    {
    	//将数据放入缓存中
    	Cache::put($this->cache_key,$this->active_users,$this->cache_expire_in_minutes);
    }
